...
const Footer = () => {
  return (
    <footer className="relative bg-[#075E54] text-white pt-20 overflow-hidden">
      {/* Background blobs */}
      <img
        src={yellowBlob}
        alt="yellow blob"
        className="absolute top-0 left-1/2 transform -translate-x-1/2 w-20 md:w-40 z-0"
      />
      <img
        src={blueBlob}
        alt="blue blob"
        className="absolute top-1/2 right-0 transform translate-y-[-50%] w-20 md:w-40 z-0"
      />
      ...
      {/* <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="bg-[#053E37] rounded-3xl py-10 shadow-lg text-center relative h-60">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 translate-y-[120%] flex w-[90%] max-w-2xl bg-white rounded-full overflow-hidden shadow-lg">
            ...
            />
            <button className="bg-[#25D366] px-4 py-3 font-semibold text-white hover:bg-green-600 transition rounded-full">
              SUBSCRIBE
            </button>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-6 mt-16 grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 relative z-10">
        ...
        <div>
          ...
          <p className="text-gray-300 mt-2 text-3xl font-bold">
            SynapStudy
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-200">
            <li>info@synapstudy.com</li>
            <li>+92 305 6787899</li>
            <li>Bank Square Market, Model Town, Lahore</li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-white flex flex-col md:flex-row justify-between items-center max-w-7xl mx-auto px-6 py-4 text-sm text-gray-300 relative z-10">
        <p>COPYRIGHT © 2025 SYNAPSTUDY. ALL RIGHTS RESERVED.</p>

        {/* Socials */}
        <div className="flex space-x-2 mt-3 md:mt-0">
          <a href="#" className="p-2 rounded-full transition hover:bg-white/20">
