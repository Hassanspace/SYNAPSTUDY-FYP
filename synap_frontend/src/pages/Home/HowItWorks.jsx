...
// Step icons (you can replace with SynapStudy-themed icons)
...
const stepsLeft = [
  {
    image: signup,
    title: "Sign Up",
    desc: "Create your SynapStudy account easily as a student or teacher.",
  },
  {
    image: selectsubject,
    title: "Join or Create a Classroom",
    desc: "Students can join classrooms, teachers can create and manage their classes.",
  },
];
...
const stepsRight = [
  {
    ...
    desc: "Access assignments, submit your work, participate in discussions, and Prepare quizzes.",
  },
  {
    image: trackprogress,
    title: "Track Your Progress",
    desc: "Monitor performance through AI-powered reports and track your learning journey.",
  },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-12 px-6 md:px-16 relative z-10">
        ...
        <div className="flex flex-col justify-between items-start h-full gap-24 mt-[-150px]">
          {stepsLeft.map((step, index) => (
            <div key={index} className="flex flex-col gap-3 items-start text-left">
              ...
              <h4 className="text-xl font-semibold text-black md:text-white">{step.title}</h4>
        ...
        <div className="flex flex-col justify-between items-end h-full gap-24 mt-[-150px]">
          {stepsRight.map((step, index) => (
            <div key={index} className="flex flex-col gap-3 items-end text-right">
              <div className="flex justify-center items-center h-14 w-14 bg-[#f2f6f7] rounded-xl shadow-md">
                <img src={step.image} alt={step.title} className="w-7 h-7" />
              </div>
              <h4 className="text-xl font-semibold text-black md:text-white">{step.title}</h4>
